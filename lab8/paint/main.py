...
def draw_equilateral_triangle(surface, color, start_pos, end_pos):
    ...
    point1 = start_pos
    point2 = (start_pos[0] + side_length / 2, start_pos[1] - h)
    point3 = (start_pos[0] - side_length / 2, start_pos[1] - h)
...
def draw_rhombus(surface, color, start_pos, end_pos):
    ...
    point1 = (start_pos[0] - dx, start_pos[1])
    point2 = (start_pos[0], start_pos[1] - dy)
    point3 = (start_pos[0] + dx, start_pos[1])
    point4 = (start_pos[0], start_pos[1] + dy)
    
    pygame.draw.polygon(surface, color, [point1, point2, point3, point4])
